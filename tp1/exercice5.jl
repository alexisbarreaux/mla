...
"""
include("./tp1/exercice5.jl")
moviesBendersDValueGurobi(1000)
"""
...
function moviesBendersDValueGurobi(n::Int64=-1, showResult::Bool= false, silent::Bool=true, timeLimit::Float64=-1.0)::Any
    if n < 0
        n=5 # Nb vars
        f =[7 , 2 , 2 , 7 , 7]
        c=[1000, 5 , 4 , 3 , 2]
